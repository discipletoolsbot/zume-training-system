...
//            33 => '/assets/images/zume_images/V5.1/1Waving1Not.svg', // @note throwing error and 33 not used. These vars should migrate to global.php:zume_training_items() as master.
        ...
        /**
         * @TODO: this will need to change as we have 20 and 2 sessions created
         * also do we need to have the link back in the pieces pages to the session that the piece can be found in?
         */
