...
export class RequestCoach extends LitElement {
    ...
    willUpdate(properties) {
        if (properties.has('variant')) {
            ...
            if (
                this.variant === Steps.languagePreferences &&
                !this.state.value
            ) {
    ...
    render() {
        ...
        return html`
            <form class="inputs stack-2" @submit=${this._handleDone}>
                ${this.variant === Steps.contactPreferences
                    ? html`
                              ...
                              ${this.contactPreferences.map(
                                  (preference) => html`
                                      <div class="form-control brand-light">
                                          ...
                                          />
                                          <label for=${'prefer_' + preference}
                                              >${this.t[preference]}</label
                                          >
                                      </div>
                                  `,
                              )}
                ...
                ${this.variant === Steps.languagePreferences
                    ? html`
                      ...
                      `
                    : ''}
                ${this.variant === Steps.howCanWeServe
                    ? html`
