...
export class ShareList extends LitElement {
    ...
    filterItems(filterType) {
        ...
        this.itemsToDisplay = this.sortItems(
                ...
                <div class="share card">
                    ...
                    >
                        <div class="stack grow-2">
                            ...
                            <p class="f--1 show-for-large">${description}</p>
                        </div>
        ...
        return html`
            <div class="container-xsm">
                ...
                >
                    ...
                    >
                    <button
                        class="icon-btn f-2 ${this.isSortedAlphabetically
                            ? 'bg-gray-300'
                            : ''}"
                ...
                >
                    <ul>
                        <li>
                            <button
                                class="menu-btn w-100 filter-button ${this
                                    .filterType === 'all'
                                    ? 'selected'
                                    : ''}"
