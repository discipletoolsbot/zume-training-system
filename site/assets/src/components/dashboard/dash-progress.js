...
export class DashProgress extends DashPage {
    ...
    loadHostStatus() {
        zumeRequest
            .get('host', { user_id: jsObject.profile.user_id })
            .then((data) => {
                ...
                <div class="list__secondary grow-0" data-align-start>
                    <div class="training-progress">
                        <button
                            ...
                            class=${this.hostProgress.list[host[0].key]
                                ? 'active'
                                : ''}
                        ...
                        <button
                            ...
                            class=${this.hostProgress.list[host[1].key]
                                ? 'active'
                                : ''}
                        ...
                        <button
                            ...
                            class=${this.hostProgress.list[host[2].key]
                                ? 'active'
                                : ''}
                        ...
                        <button
                            ...
                            class=${this.hostProgress.list[host[3].key]
                                ? 'active'
                                : ''}
        ...
        return html`
            <div class="dashboard__content">
                    ...
                    >
                        <ul>
                            <li>
                                ...
                                <button
                                    class="menu-btn w-100 ${this
                                        .filterStatus === 'not-heard'
                                        ? 'selected'
                                        : ''}"
                                    @click=${() =>
                                        this.filterProgress('not-heard')}
                                >
                ...
                <div class="dashboard__main content position-relative">
                    ...
                    <div
                        class="fixed bottom left right ${this.errorMessage
                            .length
                            ? 'p-1'
                            : ''}"
                    >
                ...
                <div class="stack-2 host-info mx-2">
                    ...
                    >
                        <host-progress-circle
                            class="grow-0"
                            type="heard"
                            percent=${this.hostProgress?.percent?.h || 0}
                        ></host-progress-circle>
                        <div class="stack--2">
                    ...
                    >
                        <host-progress-circle
                            class="grow-0"
                            type="obeyed"
                            percent=${this.hostProgress?.percent?.o || 0}
                        ></host-progress-circle>
                        <div class="stack--2">
                            <h3 class="bold">
                    ...
                    >
                        <host-progress-circle
                            class="grow-0"
                            type="shared"
                            percent=${this.hostProgress?.percent?.s || 0}
                        ></host-progress-circle>
                        <div class="stack--2">
                            <h3 class="bold">
                    ...
                    >
                        <host-progress-circle
                            class="grow-0"
                            type="trained"
                            percent=${this.hostProgress?.percent?.t || 0}
                        ></host-progress-circle>
                        <div class="stack--2">
                            <h3 class="bold">
