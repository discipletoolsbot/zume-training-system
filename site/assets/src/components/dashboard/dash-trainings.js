...
export class DashTrainings extends DashPage {
    ...
    editSession(id, event) {
        ...
        document.querySelector('#session-date-picker').value =
            sessionToEdit.date
        document.querySelector('#session-time-picker').value =
            sessionToEdit.time
    ...
    saveSession() {
        ...
        const sessionTime = DateTime.fromFormat(
            `${date} ${time}`,
            'y-LL-dd HH:mm',
        )
        zumeRequest
    ...
    markSessionCompleted(id, event) {
        ...
        makeRequest(
            'POST',
            'plan/complete-session',
            { key: this.training.join_key, session_id: id },
            'zume_system/v1',
        ).then((result) => {
        ...
        return html`
            ...
            >
                ...
                <div
                    ...
                    ?data-open=${this.openDetailStates[id]}
                >
            ...
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <div class="dashboard__title">
                        ...
                        ${this.hasMultipleTrainingGroups()
                            ? html`
                                    ${
                                        this.isEditingTitle
                                            ? html`
