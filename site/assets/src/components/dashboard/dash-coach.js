                        ...
                        ? this.coaches.map(
                              (coach) => html`
                                  <div class="card stack">
                                      <h3>${coach.name}</h3>
                                      ${coach.communication_apps.length
                                          ? html`
                                                <ul class="stack">
                                                    ${coach.communication_apps.includes(
                                                        'email',
                                                    )
                                                        ? html`
                                                              <li>
                                                            ...
                                                            if (
                                                                ...
                                                                return html`
                                                                    <li>
                                                                        <a
                                                                            class="btn"
                                                                            href="sgnl://signal.me/#p/${coach.signal}"
                                                                            >${jsObject
                                                                                .translations
                                                                                .signal}</a
                                                                        >
                                                            ...
                                                            if (
                                                                ...
                                                                return html`
                                                                    <li>
                                                                        <a
                                                                            class="btn"
                                                                            href="https://m.me/${coach.messenger}"
                                                                            target="_blank"
                                                                            >${jsObject
                                                                                .translations
                                                                                .messenger}</a
