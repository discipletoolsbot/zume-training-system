...
<!--             <div
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",ol);class Ze extends Ns(S){static get properties(){return{href:{type:String},class:{type:String},as:{type:String},locked:{type:Boolean},completed:{type:Boolean},disableNavigate:{type:Boolean},active:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.as="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.disableNavigate=!1,this.active=!1}handleClick(t){this.as==="nav"&&(t.preventDefault(),this.navigate(this.href)),this.as!=="link"&&this.as==="button"&&t.preventDefault()}printBool(t){return t?"true":"false"}render(){return c`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}}customElements.define("activity-slide",pl);class ml extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("break-slide",ml);class fl extends L{render(){var t,e;return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("center-slide",fl);class gl extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("checkin-slide",gl);class vl extends L{render(){var t;return c`
            <div class="slides-card">
        ...
        `}}customElements.define("congratulations-slide",vl);class bl extends L{render(){var t;return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("discuss-slide",bl);class yl extends L{dispatchOpenMenu(){this.dispatchEvent(new CustomEvent("presenter:open-menu",{bubbles:!0}))}render(){return c`
            <div class="slides-card">
                <div class="cover-page">
        ...
        `}}customElements.define("final-slide",yl);class $l extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column right">
                    <div>
        ...
        `}}customElements.define("left-image-slide",$l);class wl extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="cover-slide">
        ...
        `}}customElements.define("next-steps-slide",wl);class _l extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
        ...
        `}}customElements.define("obey-slide",_l);class kl extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("overview-slide",kl);class Sl extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("pray-slide",Sl);class jl extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("review-slide",jl);class Cl extends L{render(){return c`
            <div>
                <div class="slides-card">
                    ${this.renderProgressBar()}
        ...
        `}}customElements.define("video-slide",Ol);class xl extends L{nextSlide(){this.dispatchEvent(new CustomEvent("next-slide",{bubbles:!0}))}render(){var t;return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
        ...
        `}}customElements.define("watch-slide",xl);class El extends L{render(){return c`
            <div class="slides-card">
                ${this.renderProgressBar()}
                <div class="two-column left">
                    <div>
    ...
    `);window.customElements.define("play-button",sa);class Al extends S{constructor(){super();E(this,"webShareSupported",!!window.navigator.share);E(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},alwaysShow:{type:Boolean},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(e){e.stopImmediatePropagation(),navigator.share({title:this.title,url:this.url,text:this.title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(s=>console.error("Error sharing",s))}copyLink(e){e.stopImmediatePropagation(),navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(s=>console.error(s))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return c`
        ...
        `}createRenderRoot(){return this}}customElements.define("share-list",Ll);class Nl extends S{static get properties(){return{t:{type:Object},joinLink:{type:String},loading:{attribute:!1},posts:{attribute:!1}}}constructor(){super(),this.loading=!0,this.plans=[],this.getTrainings(),this.renderRow=this.renderRow.bind(this)}getTrainings(){_.post("public_plans",{}).then(t=>{this.plans=t}).catch(t=>{console.log(t)}).finally(()=>{this.loading=!1})}render(){return this.loading?c`<span class="loading-spinner active"></span>`:this.plans.length===0?c`
                <p>${this.t.no_plans}</p>
            `:c`
            <table>
                <thead>
