 ...
 */var ge,be;let b=class extends U{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=kt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return C}};b.finalized=!0,b._$litElement$=!0,(ge=globalThis.litElementHydrateSupport)===null||ge===void 0||ge.call(globalThis,{LitElement:b});const qe=globalThis.litElementPolyfillSupport;qe==null||qe({LitElement:b});((be=globalThis.litElementVersions)!==null&&be!==void 0?be:globalThis.litElementVersions=[]).push("3.3.2");class wt extends b{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},translations:{type:Object},noUrlChange:{type:Boolean},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new Fe}resetWizard(){this.modules={}}firstUpdated(){this.translations&&(this.t=window.SHAREDFUNCTIONS.escapeObject(this.translations))}willUpdate(e){e.has("type")&&this.type===""&&this.resetWizard()}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.isWizardTypeValid(this.type)?this.steps.length===0?o`
        ...
        `}footer(){return this.stepIndex===this.steps.length-1?this.finishButton():""}_onBack(){if(this.stepIndex>0){const e=this.stepIndex-1;this._gotoStep(e)}}_onNext(){if(this.stepIndex+1<this.steps.length){const e=this.stepIndex+1;this._gotoStep(e)}else this._onFinish()}_onSkip(){const e=this.step.module;for(let t=this.stepIndex+1;t<this.steps.length;t++)if(this.steps[t].module!==e){this._gotoStep(t);return}this._onFinish()}_onQuit(){this._onFinish(!0)}_handleFinish(){this._onFinish()}_onFinish(e=!1){if(this.stateManager.clear(),this.resetWizard(),!this.finishUrl){this.dispatchEvent(new CustomEvent("user-state:change",{bubbles:!0})),this.dispatchEvent(new CustomEvent("wizard-finished",{bubbles:!0}));return}const t=new URL(this.finishUrl);if(e===!1)if(this.type===j.checkin){const n=new URL(location.href).searchParams.get("code");if(n!==null){const a=new URL(jsObject.checkin_dashboard_url);a.searchParams.set("code",n),console.log("GOTO Checkin Dashboard"),window.location.href=a.href;return}}else t.searchParams.set("completed",this.type);console.log("GOTO Dashboard",e),window.location.href=t.href}_gotoStep(e,t=!0){if(this.steps.length!==0&&(this.stepIndex=this.clampSteps(e),this.step=this.steps[this.stepIndex],t&&!this.noUrlChange)){const s=new URL(window.location.href),n=s.pathname.split("/"),a=n[n.length-1];let r="";Object.values(j).includes(a)?r=n.join("/")+"/"+this.step.slug+s.search:r=n.slice(0,-1).join("/")+"/"+this.step.slug+s.search,window.history.pushState(null,null,r)}}clampSteps(e){let t=e;return e>this.steps.length-1&&(t=this.steps.length-1),e<0&&(t=0),t}_handleHistoryPopState(e=!1){const s=new URL(window.location.href).pathname.split("/"),n=s[s.length-1];Object.values(j).includes(n)&&this._gotoStep(0,!1);let a="",r=0;this.steps.forEach(({slug:l,module:c},h)=>{if(a!==c&&(a=c,r=h),n===l){if(e===!0&&this.stateManager.isDataStale()){this._gotoStep(r);return}this._gotoStep(h,!1)}})}_handlePlanDecision(e){switch(e.target.dataset.decision){case"make":this.updateWizard(j.makeAGroup);break;case"join":this.updateWizard(j.joinATraining);break;case"skip":default:this._onSkip();break}}_handleLoading(e){const{loading:t}=e.detail;this.loading=t}makeModule(e=[],t=!1){const s={steps:[],skippable:t};return e.forEach(n=>{Object.keys(N).includes(n)&&s.steps.push(N[n])}),s}getModule(e,t=!1){const s={[$.completeProfile]:{steps:[N[d.updateName],N[d.updateLocation]],skippable:t},[$.planDecision]:{steps:[{slug:"plan-decision",component:(a,r,l)=>o`
                            <div class=${`stack ${l}`}>
                        ...
                        `}]},[$.makePlan]:this.makeModule([d.howManySessions,d.whatTimeOfDay,d.howOften,d.startDate,d.inviteFriends],t),[$.inviteFriends]:{steps:[N[d.inviteFriends]],skippable:t},[$.joinTraining]:{steps:[N[d.joinTraining]]}};return Object.keys(s).includes(e)?s[e]:s[$.completeProfile]}isWizardLoaded(){return Object.keys(this.modules).length!==0}loadWizard(e,t=!1){this.modules=e,t===!1&&(this.steps=[],this.stepIndex=0),Object.entries(this.modules).forEach(([s,{steps:n,skippable:a}])=>{const r=jsObject.profile;n.forEach(({component:l,slug:c})=>{const h=mt[c];let g=null;if(h&&r){if(h.testExistance(r[h.field],r))return;g=r[h.field]}const u={component:l,slug:c,module:s,skippable:a,doneHandler:this._onNext,handleLoading:this._handleLoading};g!==null&&(u.value=g),this.steps.push(u)})}),t===!1&&this._gotoStep(0)}updateWizard(e){const t=this.getWizard(e);Object.keys(t).length!==0&&this.loadWizard(t)}isWizardTypeValid(e){return!!Object.values(j).includes(e)}getWizard(e){return this.isWizardTypeValid(e)?{[j.gettingStarted]:{[$.completeProfile]:this.makeModule([d.updateName,d.updateLocation],!0),[$.planDecision]:this.getModule($.planDecision)},[j.setProfile]:{[$.completeProfile]:this.makeModule([d.updateName,d.updateLocation],!0)},[j.makeAGroup]:{[$.makePlan]:this.getModule($.makePlan)},[j.getACoach]:{[$.completeProfile]:this.makeModule([d.updateName,d.updateLocation,d.updatePhone]),[$.getACoach]:this.makeModule([d.contactPreferences,d.languagePreferences,d.howCanWeServe,d.connectingToCoach])},[j.joinATraining]:{[$.completeProfile]:this.makeModule([d.updateName,d.updateLocation,d.updatePhone]),[$.joinTraining]:this.getModule($.joinTraining)},[j.connectWithFriend]:{[$.completeProfile]:this.makeModule([d.updateName,d.updateLocation],!0),[$.connectFriend]:this.makeModule([d.connectToFriend])},[j.joinFriendsPlan]:{[$.completeProfile]:this.makeModule([d.updateName,d.updateLocation],!0),[$.joinFriendsTraining]:this.makeModule([d.joinFriendsPlan])},[j.joinCommunity]:{[$.joinCommunity]:this.getModule($.joinCommunity)},[j.checkin]:{[$.checkin]:this.makeModule([d.checkinSubmit])}}[e]:{}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState)}createRenderRoot(){return this}}window.customElements.define("zume-wizard",wt);const N={[d.updateName]:{slug:d.updateName,component:(i,e,t)=>o`
            <complete-profile
                class=${t}
                name=${i.slug}
                module=${i.module}
 ...
 */const De=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},T=at(class extends rt{constructor(i){if(super(i),i.type!==M.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],a=[];let r=0;for(const l of i)n[r]=s?s(l,r):r,a[r]=t(l,r),r++;return{values:a,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const a=xt(i),{values:r,keys:l}=this.dt(e,t,s);if(!Array.isArray(a))return this.ht=l,r;const c=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],h=[];let g,u,p=0,m=a.length-1,f=0,y=r.length-1;for(;p<=m&&f<=y;)if(a[p]===null)p++;else if(a[m]===null)m--;else if(c[p]===l[f])h[f]=A(a[p],r[f]),p++,f++;else if(c[m]===l[y])h[y]=A(a[m],r[y]),m--,y--;else if(c[p]===l[y])h[y]=A(a[p],r[y]),Z(i,h[y+1],a[p]),p++,y--;else if(c[m]===l[f])h[f]=A(a[m],r[f]),Z(i,a[p],a[m]),m--,f++;else if(g===void 0&&(g=De(l,f,y),u=De(c,p,m)),g.has(c[p]))if(g.has(c[m])){const x=u.get(l[f]),le=x!==void 0?a[x]:null;if(le===null){const Ce=Z(i,a[p]);A(Ce,r[f]),h[f]=Ce}else h[f]=A(le,r[f]),Z(i,a[p],le),a[x]=null;f++}else ve(a[m]),m--;else ve(a[p]),p++;for(;f<=y;){const x=Z(i,h[y+1]);A(x,r[f]),h[f++]=x}for(;p<=m;){const x=a[p++];x!==null&&ve(x)}return this.ht=l,ot(i,h),C}});class O extends b{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle()}attachResizeObeserver(){const e=document.querySelector("dash-header-right"),t=new ResizeObserver(s=>{for(let n of s){if(!n.contentRect)return;const a=Math.round(n.contentRect.height),r=Math.round(n.contentRect.width);this.updateHeaderStyle(!1,a,r)}});this.resizeObserver=t,t.observe(e)}updateHeaderStyle(e=!0,t=0,s=window.innerWidth){const n=document.querySelector(".dashboard__header.left");e&&(this.initialOffset=n.offsetTop);let a;s<window.innerWidth/2?a=this.initialOffset:a=this.initialOffset+t,n.style.top=a+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class Ft extends O{static get properties(){return{showTeaser:{type:Boolean},loading:{type:Boolean,attribute:!1},commitments:{type:Array,attribute:!1},filterStatus:{type:String,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.loading=!0,this.route=v.getRoute("3-month-plan"),this.filterName="3-month-plan-filter",this.filterStatus=ZumeStorage.load(this.filterName),this.renderListItem=this.renderListItem.bind(this),this.closeCommitmentsModal=this.closeCommitmentsModal.bind(this)}firstUpdated(){super.firstUpdated();const e=this.filterStatus||"";this.fetchCommitments(e)}updated(){jQuery(document).foundation()}fetchCommitments(){const e=this.filterStatus;makeRequest("GET","commitments",{status:e},"zume_system/v1").done(t=>{this.commitments=t}).always(()=>{this.loading=!1})}openCommitmentsModal(){if(this.showTeaser)return;const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("open")}closeCommitmentsModal(){const e=document.querySelector("#new-commitments-form");jQuery(e).foundation("close")}clearCommitmentsModal(){jQuery(".post-training-plan").each(function(e){this.value=""})}addCommitments(){const e=[];return jQuery(".post-training-plan").each(function(t){const s=jQuery(this).val();if(s){const a=jQuery(this).prev().text();console.log("Question: "+a+" Answer: "+s);var n=new Date;n.setDate(n.getDate()+30),this.value="";const r=makeRequest("POST","commitment",{user_id:jsObject.profile.user_id,post_id:jsObject.profile.contact_id,meta_key:"tasks",note:"Question: "+a+" Answer: "+s,question:a,answer:s,date:n,category:"post_training_plan"},"zume_system/v1");e.push(r.promise())}}),console.log(e),Promise.all(e).then(()=>{this.fetchCommitments(),this.closeCommitmentsModal()})}completeCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("PUT","commitment",t,"zume_system/v1").done(s=>{this.fetchCommitments()})}deleteCommitment(e){let t={id:e,user_id:jsObject.profile.user_id};makeRequest("DELETE","commitment",t,"zume_system/v1").done(s=>{this.closeMenu(e),this.fetchCommitments()})}editCommitment(e){console.log(e)}filterCommitments(e){this.filterStatus=e,this.fetchCommitments(e),ZumeStorage.save(this.filterName,e),this.closeFilter()}closeFilter(){const e=this.querySelector("#filter-menu");jQuery(e).foundation("close")}closeMenu(e){const t=this.querySelector(`#kebab-menu-${e}`);jQuery(t).foundation("close")}renderListItem(e){const{question:t,answer:s,id:n,status:a}=e;return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-sidebar-toggle",ts);class Se extends Ht(b){static get properties(){return{href:{type:String},class:{type:String},locked:{type:Boolean},completed:{type:Boolean},disableNavigate:{type:Boolean},icon:{type:String},text:{type:String},explanation:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.explanation="",this.locked=!1,this.completed=!1,this.disableNavigate=!1}handleClick(e){this.disableNavigate||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return o`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",Se);class ss extends Se{constructor(){super()}renderText(){return this.text.split(" ").map(e=>o`
            <span>${e}</span>
        ...
        `}}customElements.define("grid-link",ss);class is extends Se{constructor(){super()}renderText(){return this.text.split(" ").map(e=>o`
            <span>${e}</span>
        `)}getIcon(){return this.locked?this.icon+"-locked":this.icon}render(){return o`
            <div class="container-inline">
                <div
        ...
        `}createRenderRoot(){return this}}customElements.define("course-presenter",ws);class js extends b{static get properties(){return{sections:{type:Array}}}render(){return o`
