var ht=Object.defineProperty;var ut=(i,e,t)=>e in i?ht(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var k=(i,e,t)=>(ut(i,typeof e!="symbol"?e+"":e,t),t),de=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var O=(i,e,t)=>(de(i,e,"read from private field"),t?t.call(i):e.get(i)),L=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},he=(i,e,t,s)=>(de(i,e,"write to private field"),s?s.call(i,t):e.set(i,t),t);var q=(i,e,t)=>(de(i,e,"access private method"),t);var $e;let pt=($e=class{static save(e,t){localStorage.setItem(this.createKey(e),JSON.stringify(t))}static load(e){const t=localStorage.getItem(this.createKey(e));try{return JSON.parse(t)}catch{return t}}static createKey(e){return this.prefix+e}},k($e,"prefix","Z5_"),$e);window.ZumeStorage=pt;var j,ae,Be,re,We,oe,Ze,G,ye;class Fe{constructor(e){L(this,ae);L(this,re);L(this,oe);L(this,G);k(this,"WIZARD_STATE_NAME","zume_wizard_state");k(this,"STALE_LIFESPAN",10*60*1e3);k(this,"MAX_LIFESPAN",60*60*1e3);L(this,j,void 0);this.moduleName=e,he(this,j,q(this,ae,Be).call(this))}empty(){return Object.keys(O(this,j).data).length===0}isDataStale(){return q(this,G,ye).call(this,O(this,j),this.STALE_LIFESPAN)}get(e){return O(this,j).data[e]}getAll(){return O(this,j).data}add(e,t){O(this,j).data[e]=t,q(this,oe,Ze).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(O(this,j)))}clear(){he(this,j,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}j=new WeakMap,ae=new WeakSet,Be=function(){const e=q(this,re,We).call(this);return e&&!q(this,G,ye).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},re=new WeakSet,We=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},oe=new WeakSet,Ze=function(){O(this,j).timestamp=Date.now()},G=new WeakSet,ye=function(e,t){return Date.now()-e.timestamp>t};const S={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinATraining:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin",setProfile:"set-profile",joinCommunity:"join-the-community"},$={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision",joinCommunity:"joinCommunity"},mt={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},d={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...mt},gt={[d.updateName]:{field:"name",testExistance:(i,e)=>e.has_set_name},[d.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[d.updatePhone]:{field:"phone",testExistance:i=>!!i}};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const te=window,we=te.ShadowRoot&&(te.ShadyCSS===void 0||te.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ke=Symbol(),Ee=new WeakMap;let Ke=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==ke)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(we&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=Ee.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Ee.set(t,e))}return e}toString(){return this.cssText}};const vt=i=>new Ke(typeof i=="string"?i:i+"",void 0,ke),bt=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,n,r)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+i[r+1],i[0]);return new Ke(t,i,ke)},ft=(i,e)=>{we?i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const s=document.createElement("style"),n=te.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=t.cssText,i.appendChild(s)})},xe=we?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return vt(t)})(i):i;/**
 * @license
 ...
 */const De=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},I=at(class extends rt{constructor(i){if(super(i),i.type!==T.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],r=[];let a=0;for(const l of i)n[a]=s?s(l,a):a,r[a]=t(l,a),a++;return{values:r,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){var n;const r=xt(i),{values:a,keys:l}=this.dt(e,t,s);if(!Array.isArray(r))return this.ht=l,a;const c=(n=this.ht)!==null&&n!==void 0?n:this.ht=[],h=[];let g,u,p=0,m=r.length-1,f=0,y=a.length-1;for(;p<=m&&f<=y;)if(r[p]===null)p++;else if(r[m]===null)m--;else if(c[p]===l[f])h[f]=P(r[p],a[f]),p++,f++;else if(c[m]===l[y])h[y]=P(r[m],a[y]),m--,y--;else if(c[p]===l[y])h[y]=P(r[p],a[y]),K(i,h[y+1],r[p]),p++,y--;else if(c[m]===l[f])h[f]=P(r[m],a[f]),K(i,r[p],r[m]),m--,f++;else if(g===void 0&&(g=De(l,f,y),u=De(c,p,m)),g.has(c[p]))if(g.has(c[m])){const E=u.get(l[f]),ce=E!==void 0?r[E]:null;if(ce===null){const Ce=K(i,r[p]);P(Ce,a[f]),h[f]=Ce}else h[f]=P(ce,a[f]),K(i,r[p],ce),r[E]=null;f++}else fe(r[m]),m--;else fe(r[p]),p++;for(;f<=y;){const E=K(i,h[y+1]);P(E,a[f]),h[f++]=E}for(;p<=m;){const E=r[p++];E!==null&&fe(E)}return this.ht=l,ot(i,h),C}});class z extends v{constructor(){super();const t=document.querySelector("html").dataset.dir;this.isRtl=t==="rtl"}firstUpdated(){this.attachResizeObeserver(),this.updateHeaderStyle(),window.scrollTo({top:0,behavior:"instant"})}attachResizeObeserver(){const e=document.querySelector("dash-header-right"),t=new ResizeObserver(s=>{for(let n of s){if(!n.contentRect)return;const r=Math.round(n.contentRect.height),a=Math.round(n.contentRect.width);this.updateHeaderStyle(!1,r,a)}});this.resizeObserver=t,t.observe(e)}updateHeaderStyle(e=!0,t=0,s=window.innerWidth){const n=document.querySelector(".dashboard__header.left");e&&(this.initialOffset=n.offsetTop);let r;s<window.innerWidth/2?r=this.initialOffset:r=this.initialOffset+t,n.style.top=r+"px"}disconnectedCallback(){super.disconnectedCallback(),this.resizeObserver&&this.resizeObserver.disconnect()}}class Ft extends z{static get properties(){return{showTeaser:{type:Boolean},churches:{type:Array,attribute:!1}}}constructor(){super(),this.showTeaser=!1,this.route=b.getRoute("my-churches"),this.churches=[],this.renderChurch=this.renderChurch.bind(this),this.addChurch=this.addChurch.bind(this),this.handleSubmit=this.handleSubmit.bind(this)}firstUpdated(){super.firstUpdated(),document.querySelector("#add-church-form").addEventListener("submit",this.handleSubmit)}updated(){jQuery(document).foundation()}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(e=>{const t=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(t)})}handleSubmit(e){e.preventDefault(),this.addChurch()}addChurch(){const e=this.churches.length+1,t=[{id:e,name:"This is a new church",location:"Birmingham, UK",depth:0},{id:`${e}-1`,name:"Tea Shop 1",location:"Birmingham, UK",parent:e,depth:1},{id:`${e}-2`,name:"Tea Shop 2",location:"Birmingham, UK",parent:e,depth:1},{id:`${e}-2-1`,name:"Tea Shop 2 child",location:"Birmingham, UK",parent:`${e}-2`,depth:2},{id:`${e}-3`,name:"Breakfast Shop",location:"Birmingham, UK",parent:e,depth:1}];this.churches=[...this.churches,...t],this.closeChurchModal()}editChurch(e){console.log("edit church",e)}deleteChurch(e){console.log("delete church",e)}openChurchModal(){if(this.showTeaser)return;const e=document.querySelector("#new-church-form");jQuery(e).foundation("open")}closeChurchModal(){const e=document.querySelector("#new-church-form");jQuery(e).foundation("close"),this.clearChurchModal()}clearChurchModal(){jQuery("#add-church-form input").each(function(e){this.value=""})}renderChurch({id:e,name:t,location:s,depth:n}){return o`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-top-level",le);class Wt extends le{constructor(){super("getting-started")}createRenderRoot(){return this}}customElements.define("dash-getting-started",Wt);class Zt extends z{static get properties(){return{showTeaser:{type:Boolean}}}constructor(){super(),this.showTeaser=!1}joinCommunity(){makeRequest("POST","log",{type:"system",subtype:"join_community"},"zume_system/v1/").done(e=>{const t=new CustomEvent("user-state:change",{bubbles:!0});this.dispatchEvent(t)})}render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",Zt);class Kt extends z{render(){return o`
            <div class="dashboard__content">
                <div class="dashboard__header left">
                    <dash-sidebar-toggle></dash-sidebar-toggle>
