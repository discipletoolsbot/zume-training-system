                        ...
                        `:c`
                            <ul class="list">
                                ${this.orderedChurches.length===0?c`
                                    ...
                                    `:J(this.orderedChurches,t=>`${t.id}`,this.renderChurch)}
                            </ul>
