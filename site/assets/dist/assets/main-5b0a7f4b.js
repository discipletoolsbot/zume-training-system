var Me=Object.defineProperty;var Oe=(i,e,t)=>e in i?Me(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var E=(i,e,t)=>(Oe(i,typeof e!="symbol"?e+"":e,t),t),K=(i,e,t)=>{if(!e.has(i))throw TypeError("Cannot "+t)};var k=(i,e,t)=>(K(i,e,"read from private field"),t?t.call(i):e.get(i)),D=(i,e,t)=>{if(e.has(i))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(i):e.set(i,t)},Y=(i,e,t,s)=>(K(i,e,"write to private field"),s?s.call(i,t):e.set(i,t),t);var A=(i,e,t)=>(K(i,e,"access private method"),t);import{createApp as je}from"https://unpkg.com/petite-vue?module";var _,V,Ee,J,xe,Z,Ce,H,ne;class we{constructor(e){D(this,V);D(this,J);D(this,Z);D(this,H);E(this,"WIZARD_STATE_NAME","zume_wizard_state");E(this,"STALE_LIFESPAN",10*60*1e3);E(this,"MAX_LIFESPAN",60*60*1e3);D(this,_,void 0);this.moduleName=e,Y(this,_,A(this,V,Ee).call(this))}empty(){return Object.keys(k(this,_).data).length===0}isDataStale(){return A(this,H,ne).call(this,k(this,_),this.STALE_LIFESPAN)}get(e){return k(this,_).data[e]}getAll(){return k(this,_).data}add(e,t){k(this,_).data[e]=t,A(this,Z,Ce).call(this),localStorage.setItem(this.WIZARD_STATE_NAME,JSON.stringify(k(this,_)))}clear(){Y(this,_,null),localStorage.removeItem(this.WIZARD_STATE_NAME)}}_=new WeakMap,V=new WeakSet,Ee=function(){const e=A(this,J,xe).call(this);return e&&!A(this,H,ne).call(this,e,this.MAX_LIFESPAN)?e:{module:this.moduleName,data:{},timestamp:Date.now()}},J=new WeakSet,xe=function(){return JSON.parse(localStorage.getItem(this.WIZARD_STATE_NAME))},Z=new WeakSet,Ce=function(){k(this,_).timestamp=Date.now()},H=new WeakSet,ne=function(e,t){return Date.now()-e.timestamp>t};const $={gettingStarted:"getting-started",makeAGroup:"make-a-group",getACoach:"get-a-coach",joinAPlan:"join-a-training",connectWithFriend:"connect-with-friend",joinFriendsPlan:"join-friends-training",checkin:"checkin"},m={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",getACoach:"getACoach",joinTraining:"joinTraining",connectFriend:"connectFriend",joinFriendsTraining:"joinFriendsTraining",checkin:"checkin",planDecision:"planDecision"},Ie={howManySessions:"how-many-sessions",whatTimeOfDay:"what-time-of-day",howOften:"how-often",startDate:"what-start-date"},l={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone",inviteFriends:"invite-friends",contactPreferences:"contact-preferences",languagePreferences:"preferred-language",howCanWeServe:"how-can-we-serve",connectingToCoach:"connecting-to-coach",joinTraining:"join-training",connectToFriend:"connect-friend",joinFriendsPlan:"join-friends-training",checkinSubmit:"checkin-submit",...Ie},Le={[l.updateName]:{field:"name",testExistance:(i,e)=>e.has_set_name},[l.updateLocation]:{field:"location",testExistance:i=>!(i.source&&i.source==="ip")},[l.updatePhone]:{field:"phone",testExistance:i=>!!i}};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const q=window,oe=q.ShadowRoot&&(q.ShadyCSS===void 0||q.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,le=Symbol(),he=new WeakMap;let De=class{constructor(e,t,s){if(this._$cssResult$=!0,s!==le)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(oe&&e===void 0){const s=t!==void 0&&t.length===1;s&&(e=he.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&he.set(t,e))}return e}toString(){return this.cssText}};const Ne=i=>new De(typeof i=="string"?i:i+"",void 0,le),Fe=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((s,n,o)=>s+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+i[o+1],i[0]);return new De(t,i,le)},He=(i,e)=>{oe?i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const s=document.createElement("style"),n=q.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=t.cssText,i.appendChild(s)})},de=oe?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const s of e.cssRules)t+=s.cssText;return Ne(t)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var X;const W=window,ue=W.trustedTypes,Ue=ue?ue.emptyScript:"",pe=W.reactiveElementPolyfillSupport,ae={toAttribute(i,e){switch(e){case Boolean:i=i?Ue:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,e){let t=i;switch(e){case Boolean:t=i!==null;break;case Number:t=i===null?null:Number(i);break;case Object:case Array:try{t=JSON.parse(i)}catch{t=null}}return t}},Ae=(i,e)=>e!==i&&(e==e||i==i),Q={attribute:!0,type:String,converter:ae,reflect:!1,hasChanged:Ae};let R=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;this.finalize(),((t=this.h)!==null&&t!==void 0?t:this.h=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,s)=>{const n=this._$Ep(s,t);n!==void 0&&(this._$Ev.set(n,s),e.push(n))}),e}static createProperty(e,t=Q){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const s=typeof e=="symbol"?Symbol():"__"+e,n=this.getPropertyDescriptor(e,s,t);n!==void 0&&Object.defineProperty(this.prototype,e,n)}}static getPropertyDescriptor(e,t,s){return{get(){return this[t]},set(n){const o=this[e];this[t]=n,this.requestUpdate(e,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Q}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e.h!==void 0&&(this.h=[...e.h]),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,s=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const n of s)this.createProperty(n,t[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const n of s)t.unshift(de(n))}else e!==void 0&&t.push(de(e));return t}static _$Ep(e,t){const s=t.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,s;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((s=e.hostConnected)===null||s===void 0||s.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return He(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostConnected)===null||s===void 0?void 0:s.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var s;return(s=t.hostDisconnected)===null||s===void 0?void 0:s.call(t)})}attributeChangedCallback(e,t,s){this._$AK(e,s)}_$EO(e,t,s=Q){var n;const o=this.constructor._$Ep(e,s);if(o!==void 0&&s.reflect===!0){const r=(((n=s.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?s.converter:ae).toAttribute(t,s.type);this._$El=e,r==null?this.removeAttribute(o):this.setAttribute(o,r),this._$El=null}}_$AK(e,t){var s;const n=this.constructor,o=n._$Ev.get(e);if(o!==void 0&&this._$El!==o){const r=n.getPropertyOptions(o),u=typeof r.converter=="function"?{fromAttribute:r.converter}:((s=r.converter)===null||s===void 0?void 0:s.fromAttribute)!==void 0?r.converter:ae;this._$El=o,this[o]=u.fromAttribute(t,r.type),this._$El=null}}requestUpdate(e,t,s){let n=!0;e!==void 0&&(((s=s||this.constructor.getPropertyOptions(e)).hasChanged||Ae)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),s.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,s))):n=!1),!this.isUpdatePending&&n&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((n,o)=>this[o]=n),this._$Ei=void 0);let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(e=this._$ES)===null||e===void 0||e.forEach(n=>{var o;return(o=n.hostUpdate)===null||o===void 0?void 0:o.call(n)}),this.update(s)):this._$Ek()}catch(n){throw t=!1,this._$Ek(),n}t&&this._$AE(s)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(s=>{var n;return(n=s.hostUpdated)===null||n===void 0?void 0:n.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,s)=>this._$EO(s,this[s],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}};R.finalized=!0,R.elementProperties=new Map,R.elementStyles=[],R.shadowRootOptions={mode:"open"},pe==null||pe({ReactiveElement:R}),((X=W.reactiveElementVersions)!==null&&X!==void 0?X:W.reactiveElementVersions=[]).push("1.6.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ee;const B=window,M=B.trustedTypes,ge=M?M.createPolicy("lit-html",{createHTML:i=>i}):void 0,re="$lit$",S=`lit$${(Math.random()+"").slice(9)}$`,Pe="?"+S,qe=`<${Pe}>`,O=document,L=()=>O.createComment(""),N=i=>i===null||typeof i!="object"&&typeof i!="function",ze=Array.isArray,We=i=>ze(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",te=`[ 	
\f\r]`,I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,me=/-->/g,be=/>/g,x=RegExp(`>|${te}(?:([^\\s"'>=/]+)(${te}*=${te}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ve=/'/g,fe=/"/g,Re=/^(?:script|style|textarea|title)$/i,Be=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),a=Be(1),y=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),$e=new WeakMap,T=O.createTreeWalker(O,129,null,!1),Ve=(i,e)=>{const t=i.length-1,s=[];let n,o=e===2?"<svg>":"",r=I;for(let c=0;c<t;c++){const h=i[c];let f,p,g=-1,v=0;for(;v<h.length&&(r.lastIndex=v,p=r.exec(h),p!==null);)v=r.lastIndex,r===I?p[1]==="!--"?r=me:p[1]!==void 0?r=be:p[2]!==void 0?(Re.test(p[2])&&(n=RegExp("</"+p[2],"g")),r=x):p[3]!==void 0&&(r=x):r===x?p[0]===">"?(r=n??I,g=-1):p[1]===void 0?g=-2:(g=r.lastIndex-p[2].length,f=p[1],r=p[3]===void 0?x:p[3]==='"'?fe:ve):r===fe||r===ve?r=x:r===me||r===be?r=I:(r=x,n=void 0);const C=r===x&&i[c+1].startsWith("/>")?" ":"";o+=r===I?h+qe:g>=0?(s.push(f),h.slice(0,g)+re+h.slice(g)+S+C):h+S+(g===-2?(s.push(void 0),c):C)}const u=o+(i[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[ge!==void 0?ge.createHTML(u):u,s]};class F{constructor({strings:e,_$litType$:t},s){let n;this.parts=[];let o=0,r=0;const u=e.length-1,c=this.parts,[h,f]=Ve(e,t);if(this.el=F.createElement(h,s),T.currentNode=this.el.content,t===2){const p=this.el.content,g=p.firstChild;g.remove(),p.append(...g.childNodes)}for(;(n=T.nextNode())!==null&&c.length<u;){if(n.nodeType===1){if(n.hasAttributes()){const p=[];for(const g of n.getAttributeNames())if(g.endsWith(re)||g.startsWith(S)){const v=f[r++];if(p.push(g),v!==void 0){const C=n.getAttribute(v.toLowerCase()+re).split(S),w=/([.?@])?(.*)/.exec(v);c.push({type:1,index:o,name:w[2],strings:C,ctor:w[1]==="."?Ze:w[1]==="?"?Ke:w[1]==="@"?Ye:G})}else c.push({type:6,index:o})}for(const g of p)n.removeAttribute(g)}if(Re.test(n.tagName)){const p=n.textContent.split(S),g=p.length-1;if(g>0){n.textContent=M?M.emptyScript:"";for(let v=0;v<g;v++)n.append(p[v],L()),T.nextNode(),c.push({type:2,index:++o});n.append(p[g],L())}}}else if(n.nodeType===8)if(n.data===Pe)c.push({type:2,index:o});else{let p=-1;for(;(p=n.data.indexOf(S,p+1))!==-1;)c.push({type:7,index:o}),p+=S.length-1}o++}}static createElement(e,t){const s=O.createElement("template");return s.innerHTML=e,s}}function j(i,e,t=i,s){var n,o,r,u;if(e===y)return e;let c=s!==void 0?(n=t._$Co)===null||n===void 0?void 0:n[s]:t._$Cl;const h=N(e)?void 0:e._$litDirective$;return(c==null?void 0:c.constructor)!==h&&((o=c==null?void 0:c._$AO)===null||o===void 0||o.call(c,!1),h===void 0?c=void 0:(c=new h(i),c._$AT(i,t,s)),s!==void 0?((r=(u=t)._$Co)!==null&&r!==void 0?r:u._$Co=[])[s]=c:t._$Cl=c),c!==void 0&&(e=j(i,c._$AS(i,e.values),c,s)),e}class Je{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:s},parts:n}=this._$AD,o=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:O).importNode(s,!0);T.currentNode=o;let r=T.nextNode(),u=0,c=0,h=n[0];for(;h!==void 0;){if(u===h.index){let f;h.type===2?f=new U(r,r.nextSibling,this,e):h.type===1?f=new h.ctor(r,h.name,h.strings,this,e):h.type===6&&(f=new Xe(r,this,e)),this._$AV.push(f),h=n[++c]}u!==(h==null?void 0:h.index)&&(r=T.nextNode(),u++)}return o}v(e){let t=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class U{constructor(e,t,s,n){var o;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=n,this._$Cp=(o=n==null?void 0:n.isConnected)===null||o===void 0||o}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=j(this,e,t),N(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==y&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):We(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==b&&N(this._$AH)?this._$AA.nextSibling.data=e:this.$(O.createTextNode(e)),this._$AH=e}g(e){var t;const{values:s,_$litType$:n}=e,o=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=F.createElement(n.h,this.options)),n);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===o)this._$AH.v(s);else{const r=new Je(o,this),u=r.u(this.options);r.v(s),this.$(u),this._$AH=r}}_$AC(e){let t=$e.get(e.strings);return t===void 0&&$e.set(e.strings,t=new F(e)),t}T(e){ze(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,n=0;for(const o of e)n===t.length?t.push(s=new U(this.k(L()),this.k(L()),this,this.options)):s=t[n],s._$AI(o),n++;n<t.length&&(this._$AR(s&&s._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const n=e.nextSibling;e.remove(),e=n}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class G{constructor(e,t,s,n,o){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,n){const o=this.strings;let r=!1;if(o===void 0)e=j(this,e,t,0),r=!N(e)||e!==this._$AH&&e!==y,r&&(this._$AH=e);else{const u=e;let c,h;for(e=o[0],c=0;c<o.length-1;c++)h=j(this,u[s+c],t,c),h===y&&(h=this._$AH[c]),r||(r=!N(h)||h!==this._$AH[c]),h===b?e=b:e!==b&&(e+=(h??"")+o[c+1]),this._$AH[c]=h}r&&!n&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ze extends G{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}}const Ge=M?M.emptyScript:"";class Ke extends G{constructor(){super(...arguments),this.type=4}j(e){e&&e!==b?this.element.setAttribute(this.name,Ge):this.element.removeAttribute(this.name)}}class Ye extends G{constructor(e,t,s,n,o){super(e,t,s,n,o),this.type=5}_$AI(e,t=this){var s;if((e=(s=j(this,e,t,0))!==null&&s!==void 0?s:b)===y)return;const n=this._$AH,o=e===b&&n!==b||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==b&&(n===b||o);o&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class Xe{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){j(this,e)}}const _e=B.litHtmlPolyfillSupport;_e==null||_e(F,U),((ee=B.litHtmlVersions)!==null&&ee!==void 0?ee:B.litHtmlVersions=[]).push("2.7.3");const Qe=(i,e,t)=>{var s,n;const o=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let r=o._$litPart$;if(r===void 0){const u=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;o._$litPart$=r=new U(e.insertBefore(L(),u),u,void 0,t??{})}return r._$AI(i),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var se,ie;let d=class extends R{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Qe(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return y}};d.finalized=!0,d._$litElement$=!0,(se=globalThis.litElementHydrateSupport)===null||se===void 0||se.call(globalThis,{LitElement:d});const ye=globalThis.litElementPolyfillSupport;ye==null||ye({LitElement:d});((ie=globalThis.litElementVersions)!==null&&ie!==void 0?ie:globalThis.litElementVersions=[]).push("3.3.2");class et extends d{static get properties(){return{type:{type:String},finishUrl:{type:String},user:{type:Object},step:{attribute:!1},steps:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.stepIndex=0,this.steps=[],this.modules={},this.step={},this.t=window.SHAREDFUNCTIONS.escapeObject(jsObject.translations),this._handleHistoryPopState=this._handleHistoryPopState.bind(this),window.addEventListener("popstate",this._handleHistoryPopState),this.stateManager=new we}render(){if(!this.isWizardLoaded()){const e=this.getWizard(this.type);this.loadWizard(e),this._handleHistoryPopState(!0)}return this.steps.length===0?a`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const z={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},tt=i=>(...e)=>({_$litDirective$:i,values:e});class st{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,s){this._$Ct=e,this._$AM=t,this._$Ci=s}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const it=i=>i.strings===void 0,nt={},at=(i,e=nt)=>i._$AH=e;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rt=tt(class extends st{constructor(i){if(super(i),i.type!==z.PROPERTY&&i.type!==z.ATTRIBUTE&&i.type!==z.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!it(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[e]){if(e===y||e===b)return e;const t=i.element,s=i.name;if(i.type===z.PROPERTY){if(e===t[s])return y}else if(i.type===z.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(s))return y}else if(i.type===z.ATTRIBUTE&&t.getAttribute(s)===e+"")return y;return at(i),e}});class ot extends d{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},value:{type:String},locations:{attribute:!1},locationError:{attribute:!1},phoneError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1},state:{attribute:!1},localValue:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.skippable=!1,this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this.localValue="",this.phoneError="",this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus(),this.value!==""&&(this.localValue=JSON.parse(this.value))}render(){var e;return a`
            ...
            ${this.variant===l.updateLocation?a`
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        id="city"
                        name="city"
                        .value="${this.city?rt(this.city):(e=this.localValue)==null?void 0:e.label}"
        ...
        `}_handleDone(e){e&&e.preventDefault(),this._sendDoneStepEvent()}_sendDoneStepEvent(){const e=new CustomEvent("done-step",{bubbles:!0});this.dispatchEvent(e)}_handleFinish(){setTimeout(()=>{this._sendDoneStepEvent()},3e3)}createRenderRoot(){return this}}customElements.define("make-group",gt);function mt(i){return i?JSON.parse('{"'+i.substring(1).replace(/&/g,'","').replace(/=/g,'":"')+'"}'):{}}function bt(i,e){let t={};const s=i.split("/").filter(o=>o!=""),n=e.split("/").filter(o=>o!="");return s.map((o,r)=>{/^:/.test(o)&&(t[o.substring(1)]=n[r])}),t}function vt(i){return i?new RegExp("^(|/)"+i.replace(/:[^\s/]+/g,"([\\wÀ-ÖØ-öø-ÿ-]+)")+"(|/)$"):new RegExp("(^$|^/$)")}function ft(i,e){if(vt(e).test(i))return!0}function $t(i){return class extends i{static get properties(){return{route:{type:String,reflect:!0,attribute:"route"},canceled:{type:Boolean}}}constructor(...e){super(...e),this.route="",this.canceled=!1}connectedCallback(...e){super.connectedCallback(...e),this.routing(this.constructor.routes,(...t)=>this.router(...t)),window.addEventListener("route",()=>{this.routing(this.constructor.routes,(...t)=>this.router(...t))}),window.onpopstate=()=>{window.dispatchEvent(new CustomEvent("route"))}}routed(e,t,s,n,o,r){r&&r(e,t,s,n),o(e,t,s,n)}routing(e,t){this.canceled=!0;const s=decodeURI(window.location.pathname),n=decodeURI(window.location.search);let o=e.filter(c=>c.pattern==="*")[0],r=e.filter(c=>c.pattern!=="*"&&ft(s,c.pattern))[0],u=mt(n);r?(r.params=bt(r.pattern,s),r.data=r.data||{},r.authentication&&r.authentication.authenticate&&typeof r.authentication.authenticate=="function"?(this.canceled=!1,Promise.resolve(r.authentication.authenticate.bind(this).call()).then(c=>{this.canceled||(c?r.authorization&&r.authorization.authorize&&typeof r.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(r.authorization.authorize.bind(this).call()).then(h=>{this.canceled||(h?this.routed(r.name,r.params,u,r.data,t,r.callback):this.routed(r.authorization.unauthorized.name,r.params,u,r.data,t,r.callback))})):this.routed(r.name,r.params,u,r.data,t,r.callback):this.routed(r.authentication.unauthenticated.name,r.params,u,r.data,t,r.callback))})):r.authorization&&r.authorization.authorize&&typeof r.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(r.authorization.authorize.bind(this).call()).then(c=>{this.canceled||(c?this.routed(r.name,r.params,u,r.data,t,r.callback):this.routed(r.authorization.unauthorized.name,r.params,u,r.data,t,r.callback))})):this.routed(r.name,r.params,u,r.data,t,r.callback)):o&&(o.data=o.data||{},this.routed(o.name,{},u,o.data,t,o.callback))}}}function _t(i){return class extends i{navigate(e){window.history.pushState({},null,e),window.dispatchEvent(new CustomEvent("route"))}}}class ce extends $t(d){static get properties(){return{route:{type:String},params:{type:Object},query:{type:Object}}}static get routes(){return[{name:"getting-started",pattern:`${zumeDashboard.base_url}/getting-started`,data:{component:"dash-getting-started"}},{name:"training",pattern:`${zumeDashboard.base_url}/training`,data:{component:"dash-training"}},{name:"practicing",pattern:`${zumeDashboard.base_url}/practicing`,data:{component:"dash-practicing"}},{name:"my-coach",pattern:`${zumeDashboard.base_url}/my-coach`,data:{component:"dash-coach"}},{name:"my-tools",pattern:`${zumeDashboard.base_url}/my-tools`,data:{component:"dash-tools"}},{name:"my-plans",pattern:`${zumeDashboard.base_url}/my-plans`,data:{component:"dash-plans"}},{name:"my-churches",pattern:`${zumeDashboard.base_url}/my-churches`,data:{component:"dash-churches"}},{name:"my-maps",pattern:`${zumeDashboard.base_url}/my-maps`,data:{component:"dash-maps"}},{name:"not-found",pattern:"*",data:{component:"dash-not-found"}}]}constructor(){super(),this.route="",this.params={},this.query={},this.data={},this.addEventListener("route",e=>{console.log(e)})}router(e,t,s,n){this.route=e,this.params=t,this.query=s,this.data=n}makeHref(e){return`${zumeDashboard.base_url}/${e}`}makeHrefRoute(e){const s=ce.routes.find(({name:n})=>n===e);return s?s.pattern:(console.error("MISSING ROUTE",e),"")}renderRoute(){const{component:e}=this.data;return e?document.createElement(e):""}render(){return a`
            <div class="dashboard">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-board",ce);class yt extends d{render(){return a`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-churches",yt);class kt extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-coach",kt);class St extends d{render(){return a`
            <div class="dashboard__header">
            </div>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-content",St);class wt extends d{render(){return a`
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-cta",wt);class Et extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-getting-started",Et);class xt extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
                    <h1 class="h3">Maps</h1>
                    <launch-course></launch-course>
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-maps",xt);class Ct extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-not-found",Ct);class Dt extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-plans",Dt);class At extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-practicing",At);class Pt extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-tools",Pt);class zt extends d{render(){return a`
            <div class="dashboard__content">
                <div class="dashboard__header">
        ...
        `}createRenderRoot(){return this}}customElements.define("dash-training",zt);class Rt extends _t(d){static get properties(){return{href:{type:String},class:{type:String},disabled:{type:Boolean},completed:{type:Boolean},directLink:{type:Boolean},icon:{type:String},text:{type:String}}}constructor(){super(),this.href="",this.class="",this.icon="",this.text="",this.disabled=!1,this.completed=!1,this.directLink=!1}handleClick(e){this.directLink||(e.preventDefault(),this.navigate(this.href))}printBool(e){return e?"true":"false"}render(){return a`
            <a
                href=${this.href}
                class=${this.class}
        ...
        `}createRenderRoot(){return this}}customElements.define("nav-link",Rt);class Tt extends d{render(){return a`
        ...
        `}createRenderRoot(){return this}}customElements.define("launch-course",Tt);class Mt extends d{static get properties(){return{title:{type:String},sections:{type:Array}}}render(){return a`
            <div class="container">
        ...
        `}createRenderRoot(){return this}}customElements.define("course-slideshow",It);class Lt extends d{static get properties(){return{partData:{type:Object}}}render(){switch(this.partData.type){case"section":return a`<section-part .partData=${this.partData}></section-part>`;case"watch":return a`<watch-part .partData=${this.partData}></watch-part>`;case"discuss":return a`<discuss-part .partData=${this.partData}></discuss-part>`;case"read":return a`<read-part .partData=${this.partData}></read-part>`;case"see":return a`<see-part .partData=${this.partData}></see-part>`;case"share":return a`<share-part .partData=${this.partData}></share-part>`;case"listen":return a`<listen-part .partData=${this.partData}></listen-part>`;case"form":return a`<form-part .partData=${this.partData}></form-part>`;case"checkin":return a`<checkin-part .partData=${this.partData}></checkin-part>`;case"cta":default:return a`<basic-part .partData=${this.partData}></basic-part>`}}createRenderRoot(){return this}}customElements.define("part-switcher",Lt);class Nt extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("basic-part",Nt);class Ft extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        ...
        `}createRenderRoot(){return this}}customElements.define("checkin-part",Ft);class Ht extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("discuss-part",Ht);class Ut extends d{static get properties(){return{partData:{type:Object}}}render(){return this.partData.t,this.partData.d,this.partData.info,a`
            ${this.title!==null?a`<h2>${this.title}</h2>`:""}
            ${this.description!==null?a`<p>${this.description}</p>`:""}
            ${this.info!==null?a`<p>${this.info}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("form-part",Ut);class qt extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            <h2 class="brand">LISTEN</h2>
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("listen-part",qt);class Wt extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            <h2 class="brand">READ</h2>
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("read-part",Wt);class Bt extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            ${e!==null?a`<h2>${e}</h2>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("section-part",Bt);class Vt extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            <h2 class="brand">SEE</h2>
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("see-part",Vt);class Jt extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("share-part",Jt);class Zt extends d{static get properties(){return{partData:{type:Object}}}render(){const e=this.partData.t??null,t=this.partData.d??null,s=this.partData.info??null;return a`
            ${e!==null?a`<h3>${e}</h3>`:""}
            ${t!==null?a`<p>${t}</p>`:""}
            ${s!==null?a`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("watch-part",Zt);class Te extends d{constructor(){super()}render(){return a`
            <div class="container">
                <div class="circle">
    ...
    `);window.customElements.define("play-button",Te);class Gt extends d{constructor(){super();E(this,"webShareSupported",!!window.navigator.share);E(this,"clipboardSupported",!!window.navigator.clipboard);this.shareFeedback="",this.copyFeedback=""}static get properties(){return{url:{type:String},title:{type:String},t:{type:Object},shareFeedback:{attribute:!1},copyFeedback:{attribute:!1}}}share(){navigator.share({title:this.title,url:this.url,text:title}).then(()=>{this.shareFeedback=this.t.share_feedback,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(t=>console.error("Error sharing",t))}copyLink(){navigator.clipboard.writeText(this.url).then(()=>{this.copyFeedback=this.t.copy_feedback,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(t=>console.error(t))}noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported}render(){return a`
        ...
        `}createRenderRoot(){return this}}customElements.define("share-links",Gt);class Kt extends d{static get properties(){return{t:{type:Object},joinLink:{type:String},loading:{attribute:!1},posts:{attribute:!1}}}constructor(){super(),this.loading=!0,this.plans=[],this.getTrainings(),this.renderRow=this.renderRow.bind(this)}getTrainings(){makeRequest("POST","public_plans",{},"zume_system/v1").then(e=>{this.plans=e}).catch(e=>{console.log(e)}).always(()=>{this.loading=!1})}render(){return this.loading?a`<span class="loading-spinner active"></span>`:a`
            <table>
                <thead>
                    <tr>
                        <td>${this.t.name}</td>
        ...
        `}createRenderRoot(){return this}}customElements.define("progress-circle",Yt);const Se=document.querySelector(".nav-toggle"),Xt=document.querySelector("#nav");Se&&Se.addEventListener("click",i=>{Xt.classList.toggle("nav--visible")});const Qt=({title:i,url:e,copyFeedback:t,shareFeedback:s})=>({title:i,url:e,webShareSupported:navigator.share,clipboardSupported:navigator.clipboard,shareFeedback:"",copyFeedback:"",noOptionsAvailable(){return!this.clipboardSupported&&!this.webShareSupported},share(){navigator.share({title:i,url:e,text:i}).then(()=>{this.shareFeedback=s,setTimeout(()=>{this.shareFeedback=""},3e3)}).catch(n=>console.error("Error sharing",n))},copyLink(){navigator.clipboard.writeText(e).then(()=>{this.copyFeedback=t,setTimeout(()=>{this.copyFeedback=""},3e3)}).catch(n=>console.error(n))}});window.zumeInitShareLinks=()=>{je({share:Qt}).mount()};
//# sourceMappingURL=main-5b0a7f4b.js.map
