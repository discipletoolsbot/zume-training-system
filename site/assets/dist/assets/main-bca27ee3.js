 ...
 */var V,q;let u=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const s=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=s.firstChild),s}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Lt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return $}};u.finalized=!0,u._$litElement$=!0,(V=globalThis.litElementHydrateSupport)===null||V===void 0||V.call(globalThis,{LitElement:u});const ct=globalThis.litElementPolyfillSupport;ct==null||ct({LitElement:u});((q=globalThis.litElementVersions)!==null&&q!==void 0?q:globalThis.litElementVersions=[]).push("3.3.2");const w={makeAPlan:"getting-started",connectToCoach:"connect-to-coach",joinAPlan:"join-a-training"},m={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",connectToCoach:"connectToCoach",joinPlan:"joinPlan"},g={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone"},j={[g.updateName]:{slug:g.updateName,component:(i,t)=>o`
        ...
        `}_onBack(){if(this.stepIndex>0){const t=this.stepIndex-1;this._gotoStep(t)}}_onNext(){if(this.stepIndex+1<this.steps.length){const t=this.stepIndex+1;this._gotoStep(t)}}_onSkip(){const t=this.step.module;for(let e=this.stepIndex+1;e<this.steps.length-1;e++)if(this.steps[e].module!==t){this._gotoStep(e);return}this._onFinish()}_onFinish(){this.finishUrl||(window.location.href="/"),window.location.href=this.finishUrl}_gotoStep(t,e=!0){if(this.steps.length!==0&&(this.stepIndex=this.clampSteps(t),this.step=this.steps[this.stepIndex],e)){const s=new URL(window.location.href),n=s.pathname.split("/"),r=n[n.length-1];let a="";Object.values(w).includes(r)?a=n.join("/")+"/"+this.step.slug+s.search:a=n.slice(0,-1).join("/")+"/"+this.step.slug+s.search,window.history.pushState(null,null,a)}}clampSteps(t){let e=t;return t>this.steps.length-1&&(e=this.steps.length-1),t<0&&(e=0),e}_handleHistoryPopState(){const e=new URL(window.location.href).pathname.split("/"),s=e[e.length-1];Object.values(w).includes(s)&&this._gotoStep(0,!1),this.steps.forEach(({slug:n},r)=>{s===n&&this._gotoStep(r,!1)})}makeModule(t=[],e=!1){const s={steps:[],skippable:e};return t.forEach(n=>{Object.keys(j).includes(n)&&s.steps.push(j[n])}),s}getModule(t,e=!1){const s={[m.completeProfile]:{steps:[j[g.updateName],j[g.updateLocation]],skippable:e},[m.makePlan]:{steps:[{slug:"make-a-plan",component:r=>o`
                        ...
                        `}]}};return Object.keys(s).includes(t)?s[t]:s[m.completeProfile]}isWizardLoaded(){return Object.keys(this.modules).length!==0}loadWizard(){const t=this.getWizard();this.modules=t,this.steps=[],Object.entries(this.modules).forEach(([e,{steps:s,skippable:n}])=>{s.forEach(({component:r,slug:a})=>{const h={component:r,slug:a,module:e,skippable:n};this.steps.push(h)})})}isWizardTypeValid(){return!!Object.values(w).includes(this.type)}getWizard(){return this.isWizardTypeValid()?{[w.makeAPlan]:{[m.completeProfile]:this.makeModule([g.updateName,g.updateLocation],!0),[m.makePlan]:this.getModule(m.makePlan,!0),[m.inviteFriends]:this.getModule(m.inviteFriends,!0)},[w.connectToCoach]:{[m.completeProfile]:this.makeModule([g.updateName,g.updateLocation,g.updatePhone]),[m.connectToCoach]:this.getModule(m.connectToCoach)},[w.joinAPlan]:{[m.completeProfile]:this.makeModule([g.updateName,g.updateLocation,g.updatePhone]),[m.joinPlan]:this.getModule(m.joinPlan)}}[this.type]:{}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._handleHistoryPopState)}createRenderRoot(){return this}}window.customElements.define("zume-wizard",jt);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ut=i=>i.strings===void 0,Ht={},Mt=(i,t=Ht)=>i._$AH=t;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Wt=zt(class extends Nt{constructor(i){if(super(i),i.type!==S.PROPERTY&&i.type!==S.ATTRIBUTE&&i.type!==S.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ut(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===$||t===f)return t;const e=i.element,s=i.name;if(i.type===S.PROPERTY){if(t===e[s])return $}else if(i.type===S.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(s))return $}else if(i.type===S.ATTRIBUTE&&e.getAttribute(s)===t+"")return $;return Mt(i),t}});class Bt extends u{static get properties(){return{name:{type:String},module:{type:String},t:{type:Object},variant:{type:String},locations:{attribute:!1},locationError:{attribute:!1},city:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this._handleLocationsChange=this._handleLocationsChange.bind(this),this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus()}render(){return o`
        <div class="inputs">
            ${this.variant==="name"?o`
        ...
        `}createRenderRoot(){return this}}customElements.define("share-part",ie);class ne extends u{static get properties(){return{partData:{type:Object}}}render(){const t=this.partData.t??null,e=this.partData.d??null,s=this.partData.info??null;return o`
            ...
            ${e!==null?o`<p>${e}</p>`:""}
            ${s!==null?o`<p>${s}</p>`:""}
        `}createRenderRoot(){return this}}customElements.define("watch-part",ne);class vt extends u{constructor(){super()}render(){return o`
            <div class="container">
                <div class="circle">
...
//# sourceMappingURL=main-bca27ee3.js.map
