 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var F;const N=window,k=N.trustedTypes,st=k?k.createPolicy("lit-html",{createHTML:i=>i}):void 0,Z="$lit$",y=`lit$${(Math.random()+"").slice(9)}$`,ft="?"+y,At=`<${ft}>`,E=document,I=()=>E.createComment(""),R=i=>i===null||typeof i!="object"&&typeof i!="function",mt=Array.isArray,kt=i=>mt(i)||typeof(i==null?void 0:i[Symbol.iterator])=="function",W=`[ 	
\f\r]`,P=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,it=/-->/g,nt=/>/g,_=RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ot=/'/g,rt=/"/g,vt=/^(?:script|style|textarea|title)$/i,Et=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),o=Et(1),$=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),at=new WeakMap,A=E.createTreeWalker(E,129,null,!1),Ct=(i,t)=>{const e=i.length-1,s=[];let n,r=t===2?"<svg>":"",a=P;for(let l=0;l<e;l++){const c=i[l];let b,d,p=-1,g=0;for(;g<c.length&&(a.lastIndex=g,d=a.exec(c),d!==null);)g=a.lastIndex,a===P?d[1]==="!--"?a=it:d[1]!==void 0?a=nt:d[2]!==void 0?(vt.test(d[2])&&(n=RegExp("</"+d[2],"g")),a=_):d[3]!==void 0&&(a=_):a===_?d[0]===">"?(a=n??P,p=-1):d[1]===void 0?p=-2:(p=a.lastIndex-d[2].length,b=d[1],a=d[3]===void 0?_:d[3]==='"'?rt:ot):a===rt||a===ot?a=_:a===it||a===nt?a=P:(a=_,n=void 0);const T=a===_&&i[l+1].startsWith("/>")?" ":"";r+=a===P?c+At:p>=0?(s.push(b),c.slice(0,p)+Z+c.slice(p)+y+T):c+y+(p===-2?(s.push(void 0),l):T)}const h=r+(i[e]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[st!==void 0?st.createHTML(h):h,s]};class D{constructor({strings:t,_$litType$:e},s){let n;this.parts=[];let r=0,a=0;const h=t.length-1,l=this.parts,[c,b]=Ct(t,e);if(this.el=D.createElement(c,s),A.currentNode=this.el.content,e===2){const d=this.el.content,p=d.firstChild;p.remove(),d.append(...p.childNodes)}for(;(n=A.nextNode())!==null&&l.length<h;){if(n.nodeType===1){if(n.hasAttributes()){const d=[];for(const p of n.getAttributeNames())if(p.endsWith(Z)||p.startsWith(y)){const g=b[a++];if(d.push(p),g!==void 0){const T=n.getAttribute(g.toLowerCase()+Z).split(y),H=/([.?@])?(.*)/.exec(g);l.push({type:1,index:r,name:H[2],strings:T,ctor:H[1]==="."?It:H[1]==="?"?Dt:H[1]==="@"?Ot:U})}else l.push({type:6,index:r})}for(const p of d)n.removeAttribute(p)}if(vt.test(n.tagName)){const d=n.textContent.split(y),p=d.length-1;if(p>0){n.textContent=k?k.emptyScript:"";for(let g=0;g<p;g++)n.append(d[g],I()),A.nextNode(),l.push({type:2,index:++r});n.append(d[p],I())}}}else if(n.nodeType===8)if(n.data===ft)l.push({type:2,index:r});else{let d=-1;for(;(d=n.data.indexOf(y,d+1))!==-1;)l.push({type:7,index:r}),d+=y.length-1}r++}}static createElement(t,e){const s=E.createElement("template");return s.innerHTML=t,s}}function C(i,t,e=i,s){var n,r,a,h;if(t===$)return t;let l=s!==void 0?(n=e._$Co)===null||n===void 0?void 0:n[s]:e._$Cl;const c=R(t)?void 0:t._$litDirective$;return(l==null?void 0:l.constructor)!==c&&((r=l==null?void 0:l._$AO)===null||r===void 0||r.call(l,!1),c===void 0?l=void 0:(l=new c(i),l._$AT(i,e,s)),s!==void 0?((a=(h=e)._$Co)!==null&&a!==void 0?a:h._$Co=[])[s]=l:e._$Cl=l),l!==void 0&&(t=C(i,l._$AS(i,t.values),l,s)),t}class Pt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:s},parts:n}=this._$AD,r=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:E).importNode(s,!0);A.currentNode=r;let a=A.nextNode(),h=0,l=0,c=n[0];for(;c!==void 0;){if(h===c.index){let b;c.type===2?b=new O(a,a.nextSibling,this,t):c.type===1?b=new c.ctor(a,c.name,c.strings,this,t):c.type===6&&(b=new Tt(a,this,t)),this._$AV.push(b),c=n[++l]}h!==(c==null?void 0:c.index)&&(a=A.nextNode(),h++)}return r}v(t){let e=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class O{constructor(t,e,s,n){var r;this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=n,this._$Cp=(r=n==null?void 0:n.isConnected)===null||r===void 0||r}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=C(this,t,e),R(t)?t===f||t==null||t===""?(this._$AH!==f&&this._$AR(),this._$AH=f):t!==this._$AH&&t!==$&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):kt(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==f&&R(this._$AH)?this._$AA.nextSibling.data=t:this.$(E.createTextNode(t)),this._$AH=t}g(t){var e;const{values:s,_$litType$:n}=t,r=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=D.createElement(n.h,this.options)),n);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===r)this._$AH.v(s);else{const a=new Pt(r,this),h=a.u(this.options);a.v(s),this.$(h),this._$AH=a}}_$AC(t){let e=at.get(t.strings);return e===void 0&&at.set(t.strings,e=new D(t)),e}T(t){mt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,n=0;for(const r of t)n===e.length?e.push(s=new O(this.k(I()),this.k(I()),this,this.options)):s=e[n],s._$AI(r),n++;n<e.length&&(this._$AR(s&&s._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,e);t&&t!==this._$AB;){const n=t.nextSibling;t.remove(),t=n}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class U{constructor(t,e,s,n,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=f}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,n){const r=this.strings;let a=!1;if(r===void 0)t=C(this,t,e,0),a=!R(t)||t!==this._$AH&&t!==$,a&&(this._$AH=t);else{const h=t;let l,c;for(t=r[0],l=0;l<r.length-1;l++)c=C(this,h[s+l],e,l),c===$&&(c=this._$AH[l]),a||(a=!R(c)||c!==this._$AH[l]),c===f?t=f:t!==f&&(t+=(c??"")+r[l+1]),this._$AH[l]=c}a&&!n&&this.j(t)}j(t){t===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class It extends U{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===f?void 0:t}}const Rt=k?k.emptyScript:"";class Dt extends U{constructor(){super(...arguments),this.type=4}j(t){t&&t!==f?this.element.setAttribute(this.name,Rt):this.element.removeAttribute(this.name)}}class Ot extends U{constructor(t,e,s,n,r){super(t,e,s,n,r),this.type=5}_$AI(t,e=this){var s;if((t=(s=C(this,t,e,0))!==null&&s!==void 0?s:f)===$)return;const n=this._$AH,r=t===f&&n!==f||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,a=t!==f&&(n===f||r);r&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;typeof this._$AH=="function"?this._$AH.call((s=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}}class Tt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){C(this,t)}}const lt=N.litHtmlPolyfillSupport;lt==null||lt(D,O),((F=N.litHtmlVersions)!==null&&F!==void 0?F:N.litHtmlVersions=[]).push("2.7.3");const Ht=(i,t,e)=>{var s,n;const r=(s=e==null?void 0:e.renderBefore)!==null&&s!==void 0?s:t;let a=r._$litPart$;if(a===void 0){const h=(n=e==null?void 0:e.renderBefore)!==null&&n!==void 0?n:null;r._$litPart$=a=new O(t.insertBefore(I(),h),h,void 0,e??{})}return a._$AI(i),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var q,V;let u=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const s=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=s.firstChild),s}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ht(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return $}};u.finalized=!0,u._$litElement$=!0,(q=globalThis.litElementHydrateSupport)===null||q===void 0||q.call(globalThis,{LitElement:u});const ct=globalThis.litElementPolyfillSupport;ct==null||ct({LitElement:u});((V=globalThis.litElementVersions)!==null&&V!==void 0?V:globalThis.litElementVersions=[]).push("3.3.2");const w={makeAPlan:"getting-started",connectToCoach:"connect-to-coach",joinAPlan:"join-a-training"},m={completeProfile:"completeProfile",makePlan:"makePlan",inviteFriends:"inviteFriends",connectToCoach:"connectToCoach",joinPlan:"joinPlan"},v={updateName:"update-your-name",updateLocation:"update-your-location",updatePhone:"update-your-phone"},j={[v.updateName]:{slug:v.updateName,component:(i,t)=>o`
                            <complete-profile
                                name=${i.slug}
                                module=${i.module}
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bt=zt(class extends Lt{constructor(i){if(super(i),i.type!==S.PROPERTY&&i.type!==S.ATTRIBUTE&&i.type!==S.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Nt(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===$||t===f)return t;const e=i.element,s=i.name;if(i.type===S.PROPERTY){if(t===e[s])return $}else if(i.type===S.BOOLEAN_ATTRIBUTE){if(!!t===e.hasAttribute(s))return $}else if(i.type===S.ATTRIBUTE&&e.getAttribute(s)===t+"")return $;return Mt(i),t}});class Ft extends u{static get properties(){return{name:{type:String},module:{type:String},skippable:{type:Boolean},t:{type:Object},variant:{type:String},locations:{attribute:!1},locationError:{attribute:!1},city:{attribute:!1},loading:{attribute:!1}}}constructor(){super(),this.name="",this.module="",this.variant="",this.t={},this.locations=[],this.locationError="",this.city="",this.loading=!1,this._clearLocations=this._clearLocations.bind(this),this._handleSuggestions=this._handleSuggestions.bind(this),this._debounceCityChange=debounce(getAddressSuggestions(this._handleSuggestions,zumeProfile.map_key)).bind(this),this._handleCityInputChange=this._handleCityInputChange.bind(this)}firstUpdated(){this.renderRoot.querySelector(".inputs input").focus()}render(){return o`
        <form class="inputs">
            ${this.variant==="name"?o`
...
//# sourceMappingURL=main-deb0d873.js.map
