...
class Zume_Course_Builder {
    ...
    private static function _build( $session_type = '10', $lang_code = 'en', $session_number = '1' ) {
        ...
        foreach( $content as $item ) {
            if ( in_array( $item['key'], $session ) ) {
                ...
                $slides[$item['key']]['length'] = self::_slide_length( $item, $session_type );
            }
        }
    ...
    private static function _session_keys( $session_type, $session_number ) {
        ...
        if ( '10' === $session_type ) {
            ...
            $all['3'] = ['s1_3_1','s1_3_2','s1_3_3','s1_3_4','s1_3_5',false,'t9_a','t9_b','t9_c',false,'t10_a','t10_b','t10_c','t10_d','t10_e',false,'s1_3_8',false,'t11_a','t11_b','t11_c','t11_d',false,'s1_3_10','s1_3_11','s1_3_12','final']; // sesssion 3
            ...
            $all['9'] = ['s2_9_1','s2_9_2','s2_9_3','s2_9_4','s2_9_5',false,'s2_9_6','s2_9_7','s2_9_8','s2_9_9','final'];    // session 9
            ...
            $all['13'] = ['s2_13_1','s2_13_2','s2_13_3','s2_13_4','s2_13_5',false,'t20_a','t20_b','t20_c',false,'t21_aa','t21_b','t21_cc',false,'s2_13_6','s2_13_7','final'];     // session 13
            ...
            $all['2'] = ['s1_3_1','s1_3_2','s1_3_3','s1_3_5',false,'t9_a','t9_b','t9_c',false,'t10_a','t10_b','t10_c','t10_d','t10_e',false,'s1_3_8',false,'t11_a','t11_b','t11_c','t11_d',false,'s1_3_10','s1_3_12',false,'break',false, // session 3
        ...
        return $all[$session_number];
    }

    private static function _slide_length( $item, $session_type ) {
