                ...
                <ul class="stack-2 | progress-menu accordion-menu" data-accordion-menu data-submenu-toggle="true">
                    <li class="menu-section">
                        ...
                        <ul class="nested is-active">
                            ...
                            <li><a class="menu-btn" href="#" aria-disabled="true" data-completed="true"><span class="icon zume-start-group brand-light"></span><span><?php echo esc_html__( 'Plan a Training', 'zume' ) ?></span></a><span class="icon zume-check-mark success"></span></li>
