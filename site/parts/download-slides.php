        ...
        <div class="switcher | gap-3">
            ...
            <div class="switcher | gap-3">
                <div class="stack center | text-center">
                    ...
                    <?php if ( $ppt_10 ) { ?>
                        <a class="btn w-100" target="_blank" href="<?php echo esc_url( $ppt_10 ) ?>"><?php echo esc_html__( '10 Session Course', 'zume' ) ?></a>
                    <?php } ?>
                    <?php if ( $ppt_20 ) { ?>
                        <a class="btn w-100" target="_blank" href="<?php echo esc_url( $ppt_20 ) ?>"><?php echo esc_html__( '20 Session Course', 'zume' ) ?></a>
                    <?php } ?>
                    <?php if ( $ppt_intense ) { ?>
                        <a class="btn w-100" target="_blank" href="<?php echo esc_url( $ppt_intense ) ?>"><?php echo esc_html__( 'Intensive Course', 'zume' ) ?></a>
                    <?php } ?>
                </div>
                <div class="stack center | text-center">
                    <div class="center"><strong><?php echo esc_html__( 'Keynote', 'zume' ) ?></strong></div>
                    <?php if ( $key_10 ) { ?>
                        <a class="btn w-100" target="_blank" href="<?php echo esc_url( $key_10 ) ?>"><?php echo esc_html__( '10 Session Course', 'zume' ) ?></a>
                    <?php } ?>
                    <?php if ( $key_20 ) { ?>
                        <a class="btn w-100" target="_blank" href="<?php echo esc_url( $key_20 ) ?>"><?php echo esc_html__( '20 Session Course', 'zume' ) ?></a>
                    <?php } ?>
                    <?php if ( $key_intense ) { ?>
                        <a class="btn w-100" target="_blank" href="<?php echo esc_url( $key_intense ) ?>"><?php echo esc_html__( 'Intensive Course', 'zume' ) ?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
