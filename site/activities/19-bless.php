...
class Zume_Activites_Bless extends Zume_Magic_Page
{
    use Translateable;

    public $magic = false;
    public $parts = false;
    public $page_title = 'Zúme Activity - BLESS';
    public $root = 'zume_activity';
    public $type = 'bless';
    public $lang;
    public static $token = 'zume_activity_bless';
    ...
    public function body(){
        ...
        <div class="zume-activity">
            <div class="zume-activity-header">
                <h1><?php echo __( 'Practice the B.L.E.S.S. Prayer', 'zume' )  ?></h1>
                <hr>
            </div>
