...
class Zume_Activites_33groupmk5 extends Zume_Magic_Page
{
    use Translateable;
    ...
    public $lang;
    public static $token = 'zume_activity_33groupm6';
        ...
        <div class="zume-activity">
            ...
            <div class="zume-activity-content">
                <ul>
                    ...
                    <li>LOOK UP – Use Mark 5:1-20 as your group’s reading passage and answer questions 1-4 during the Look Up section. (30 min)</li>
                    <li>LOOK FORWARD – Use questions 5, 6, and 7 in the Look Forward section to develop how you will Obey, Train and Share. (30 min)</li>
                </ul>
            </div>
        </div>
        <?php
