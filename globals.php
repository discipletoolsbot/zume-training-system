...
//if ( ! function_exists( 'zume_types_and_subtypes' ) ) {
//    function zume_types_and_subtypes() : array {
//
//
//        $system = [
//            'registered',
//            'requested_a_coach',
//            'joined_online_training',
//            'made_a_plan',
//            'set_profile',
//            'invited_friends',
//            'joined_online_training',
//            'made_first_lifestyle_report',
//            'submitted_progress_report',
//            'seeing_generational_fruit',
//            'joined_affinity_hub',
//        ];
//
//        $zume_training_items = zume_training_items();
//        $training = [];
//        $coaching = [];
//
//        foreach( $zume_training_items as $host ) {
//            $training[] = $host['host'];
//        }
//        foreach( $zume_training_items as $mawl ) {
//
//        }
//
//
